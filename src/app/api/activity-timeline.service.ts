...
export class ActivityTimelineService {
  ...
  getClientActivity(
    ...
    return this.http.get<ActivityTimelineResponse>(
      `${this.baseUrl}/companies/${companyId}/clients/${clientId}/activity`,
      { params: httpParams }
    );
  }
  ...
  getMemberActivity(
    ...
    return this.http.get<ActivityTimelineResponse>(
      `${this.baseUrl}/companies/${companyId}/members/${userId}/activity`,
      { params: httpParams }
    );
  }
  ...
  getJobsiteActivity(
    ...
    return this.http.get<ActivityTimelineResponse>(
      `${this.baseUrl}/companies/${companyId}/jobsites/${jobsiteId}/activity`,
      { params: httpParams }
    );
  }
}
