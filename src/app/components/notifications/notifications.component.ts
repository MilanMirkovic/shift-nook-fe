...
export class NotificationsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    // Subscribe to selected company and load notifications when we have a company
    this.store.select(selectSelectedCompanyId)
      .pipe(takeUntil(this.destroy$))
      .subscribe(companyId => {
        this.selectedCompanyId = companyId;
        // Load notifications whenever company changes (including initial load)
  ...
  protected onFilterChange(mode: 'all' | 'unread'): void {
  ...
  protected onLoadMore(): void {
    this.notificationsStore.loadMoreNotifications(this.currentPage, this.filterMode === 'unread', this.selectedCompanyId ?? undefined);
  }
